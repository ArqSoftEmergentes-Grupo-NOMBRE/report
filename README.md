...
- **Jorge Arévalo, Ramón Alejandro:** Corrección de class y database diagrams. Desarrollo del Sprint Planning y Sprint Backlog 1. Aporte en el desarrollo de los endpoints de los histos en el RESTful API.
