...
| Endpoint            | HTTP Verb | Syntax              | Parámetros                           | Ejemplo de Response                                      | URL Documentación                                                                                                         | Commit ID |
| ------------------- | --------- | ------------------- | ------------------------------------ | -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | --------- |
| /contracts          | POST      | /contracts          | JSON (owner, data)                   | {"hash": "abc123", "message": "Contrato en cola/minado"} | [https://contracts.backend.tarket.site:3029/contracts\_post](https://contracts.backend.tarket.site:3029/contracts_post)   | x1y2z3a   |
| /contracts/{hash}   | GET       | /contracts/\:hash   | hash (string)                        | JSON con detalle del contrato                            | [https://contracts.backend.tarket.site:3029/contracts\_get](https://contracts.backend.tarket.site:3029/contracts_get)     | b4c5d6e   |
| /chain              | GET       | /chain              | Ninguno                              | \[Lista de bloques JSON]                                 | [https://contracts.backend.tarket.site:3029/chain](https://contracts.backend.tarket.site:3029/chain)                      | a1b2c3d   |
| /queue              | GET       | /queue              | Ninguno                              | {"queued": 3}                                            | [https://contracts.backend.tarket.site:3029/queue](https://contracts.backend.tarket.site:3029/queue)                      | d4e5f6g   |
| /status             | GET       | /status             | Ninguno                              | {"height": 5, "queued": 2, "mining": true, "diff": 2}    | [https://contracts.backend.tarket.site:3029/status](https://contracts.backend.tarket.site:3029/status)                    | h7i8j9k   |
| /difficulty         | GET       | /difficulty         | Ninguno                              | {"difficulty": 2}                                        | [https://contracts.backend.tarket.site:3029/difficulty\_get](https://contracts.backend.tarket.site:3029/difficulty_get)   | l1m2n3o   |
| /difficulty         | POST      | /difficulty         | difficulty (int)                     | {"difficulty": 3}                                        | [https://contracts.backend.tarket.site:3029/difficulty\_post](https://contracts.backend.tarket.site:3029/difficulty_post) | p4q5r6s   |
| /validate           | GET       | /validate           | Ninguno                              | {"ok": true} o {"ok": false, error: "..."}               | [https://contracts.backend.tarket.site:3029/validate](https://contracts.backend.tarket.site:3029/validate)                | t7u8v9w   |
| /auth/register      | POST      | /auth/register      | JSON (username, password, etc.)      | {"user": "jtorres", "status": "registered"}              | [https://contracts.backend.tarket.site:3029/auth/register](https://contracts.backend.tarket.site:3029/auth/register)      | j1k2l3m   |
| /auth/login         | POST      | /auth/login         | JSON (username, password)            | {"token": "jwt...", "user": "jtorres"}                   | [https://contracts.backend.tarket.site:3029/auth/login](https://contracts.backend.tarket.site:3029/auth/login)            | f7g8h9i   |
| /milestones         | GET       | /milestones         | Ninguno                              | \[ { index: 1, title: "...", ... } ]                     | [https://contracts.backend.tarket.site:3029/milestones](https://contracts.backend.tarket.site:3029/milestones)            | b4c5d6e   |
| /milestones/{index} | GET       | /milestones/\:index | index (int)                          | Lista de hitos del contrato                              | [https://contracts.backend.tarket.site:3029/milestone\_get](https://contracts.backend.tarket.site:3029/milestone_get)     | n4o5p6q   |
| /milestones/{index} | POST      | /milestones/\:index | index (int), JSON con datos del hito | {"message": "Milestone added"}                           | [https://contracts.backend.tarket.site:3029/milestone\_post](https://contracts.backend.tarket.site:3029/milestone_post)   | x1y2z3a   |
